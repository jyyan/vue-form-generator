<template lang="pug">
	input(:id="getFieldID(schema)", type="submit", :value="safeSchemaValue('buttonText')", @click="onClick", :name="safeSchemaValue('inputName')", :disabled="disabled", :class="fieldClasses", v-attributes="'input'")
</template>
