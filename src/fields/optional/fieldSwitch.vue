<template lang="pug">
	label
		input(type="checkbox", v-model="value", :autocomplete="safeSchemaValue('autocomplete')", :disabled="disabled", :name="safeSchemaValue('inputName')", :id="getFieldID(schema)")
		span.label(:data-on="safeSchemaValue('textOn', 'On')", :data-off="safeSchemaValue('textOff', 'Off')", :for="getFieldID(schema)")
		span.handle
</template>
