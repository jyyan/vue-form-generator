<template lang="pug">
	input.form-control(type="text", v-model="value", :autocomplete="safeSchemaValue('autocomplete')", :disabled="disabled", :placeholder="safeSchemaValue('placeholder')", :readonly="safeSchemaValue('readonly')", :name="safeSchemaValue('inputName')")
</template>
