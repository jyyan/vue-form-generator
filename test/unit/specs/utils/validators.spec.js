...
describe("Validators", () => {
	describe("test Validators.required", () => {
		it("should NOT give error if value is null, but field is NOT required", async () => {
			check(v.required, null, { required: false }, 0);
		});

		it("should give error if value is null, but field is required", async () => {
	...
	describe("test Validators.number", () => {
		...
		it("should give error if value is NaN or Infinity", async () => {
			check(v.number, NaN, field, 1);
			check(v.number, Infinity, field, 1);
			check(v.number, -Infinity, field, 1);
		});

		it("should give error if value is smaller than min", async () => {
			check(v.number, -1, field, 1);
			check(v.number, 0, field, 1);
			check(v.number, 3, field, 1);
		});

		it("should give error if value is greater than max", async () => {
			check(v.number, 15, field, 1);
		});

		it("should not give error", async () => {
		...
		it("should give error if value is string", async () => {
		...
		it("should not give error if value is null and  field is not required", async () => {
	...
	describe("test Validators.integer", () => {
		...
		it("should give error if value is not integer", async () => {
			// invalid integer
		...
		it("should not give error if value is integer", async () => {
	...
	describe("test Validators.double", () => {
		...
		it("should give error if value is not double", async () => {
			check(v.double, "3,14", field, 1);
			check(v.double, false, field, 1);
		});

		it("should not give error if value is double", async () => {
	...
	describe("test Validators.string", () => {
		...
		it("should give error if value is not string", async () => {
	...
	describe("test Validators.array", () => {
		...
		it("should give error if count of items is smaller than min", async () => {
		...
		it("should give error if count of items is greater than max", async () => {
			check(v.array, [1, 2, 3, 4, 5], field, 1);
		});

		it("should give error if value is not array", async () => {
		...
		it("should give error if count of item is smaller than minimum and field is not required", async () => {
			field.required = false;
	...
	describe("test Validators.date", () => {
		...
		it("should give error if value is not a date", async () => {
	...
	describe("test Validators.regexp", () => {
		...
		it("should give error if value is not matched the pattern", async () => {
	...
	describe("test Validators.alpha", () => {
		...
		it("should give error if value is not alpha", async () => {
	...
	describe("test Validators.alphaNumeric", () => {
		...
		it("should give error if value is not alphaNumeric", async () => {
	...
	describe("test localized error messages", () => {
		...
		it("should give the default error message", async () => {
		...
		it("should give the localized error message", async () => {
	...
	describe("test local custom error messages", () => {
		...
		it("should give the custom error message", async () => {
